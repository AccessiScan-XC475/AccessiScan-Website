  ...
  return (
    <div>
      ...
      <p className="text-center mb-4">
        This page displays how often people choose certain accessibility options. We, as a team, are curious to see 
        which options get chosen the most. We will use this data to improve our platform and the information we offer.
      </p>
