    ...
    <div className="flex flex-col items-center">
      ...
      <div className="flex flex-col items-center">
        <div className="flex items-center p-1 m-2">
          ...
          <Select value={selection} label="Goal" className="w-32 p-0.25" onChange={(e) => setSelection(e.target.value)}>
        ...
        className="py-2 px-6 m-4 bg-green-500 rounded-xl">Go!</button>
      </div>
    </div>
  )
}
